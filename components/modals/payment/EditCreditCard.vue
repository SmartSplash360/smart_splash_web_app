    ...
    >
      ...
      <div class="flex flex-col gap-2">
        ...
        <div class="flex gap-4 mt-10">
          ...
          <span class="span__element text-gray-500 leading-normal max-w-[500px]"
            ...
            (currently R199/month) to your payment method until you cancel. You
...
const addCreditCard = async () => {
  ...
  try {
    props.toggleEditCreditCardModal({
      success: "Card added created successfully",
    });
  } catch (e) {
