<template>
  <div
    class="flex flex-col gap-5 items-center xl:border-b dark:border-b-gray-600 pb-5"
  >
    <Dropdown
      v-model="activity"
      :options="activities"
      ...
      >
        ...
        <div class="flex flex-col gap-2 px-5">
          <div class="flex-between w-full">
            ...
            <span class="span__element-small"> {{ chat.time }} AM</span>
          </div>
          <span class="span__element">
            {{ chat.subject }}
          </span>
          <span
            class="max-h-[60px] overflow-hidden text-ellipsis span__element"
          >
            {{ chat.message }}
          </span>
        </div>
    ...
    >
      ...
      >
        ...
        <div class="flex flex-col gap-2 px-2">
          ...
          <span
            class="max-h-[45px] overflow-hidden text-ellipsis span__element-small text-gray-700 dark:text-gray-400"
          >
            {{ chat.message }}
          </span>
        </div>
...
const activity = ref("");
const activities = ref([{ option: "Recent" }, { option: "Old chat" }]);
