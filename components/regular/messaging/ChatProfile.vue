<template>
  <div
    v-if="selectedChat"
    class="hidden h-full flex-col border-l border-r dark:border-l-gray-600 dark:border-r-gray-600 xl:flex"
  >
    <div
    ...
    >
      ...
      <div class="flex-center w-full gap-5">
        <span
          class="flex-center h-[40px] w-[40px] cursor-pointer rounded-md bg-[#D9D9D9] span__element text-[#656565]"
    ...
    <ul class="flex flex-col gap-8 px-5 py-10">
      <li
      ...
      >
        <img
          ...
          alt="location-icon"
        />
        <span class="span__element">{{ selectedChat.address }}</span>
      </li>
    </ul>
  </div>
</template>
