<template>
  <div role="status" class="flex w-full animate-pulse justify-between gap-2">
    <ul class="flex w-full flex-col gap-5 p-2 lg:w-1/4 lg:border-r">
      <li class="rounded bg-gray-100 p-4">
        ...
        >
          ...
          <div class="w-full">
            <div
              class="mb-2 h-2 w-1/2 rounded-full bg-gray-200 dark:bg-gray-700"
            ></div>
            <div
    ...
    <div
      class="hidden flex-col gap-10 rounded-lg bg-gray-100 px-10 py-5 lg:flex lg:w-3/4"
    >
      <div
        role="status"
        class="animate-pulse space-y-8 md:flex md:items-center md:space-x-8 md:space-y-0"
      >
        ...
        <div class="w-full">
          <div
            class="mb-2 h-2 w-24 rounded-full bg-gray-200 dark:bg-gray-700"
          ></div>
          <div
            class="mb-2 h-2 w-28 rounded-full bg-gray-200 dark:bg-gray-700"
          ></div>
        </div>
      </div>
      <div>
        ...
        ></div>
        <div
          class="mb-2.5 h-2 max-w-[480px] rounded-full bg-gray-200 dark:bg-gray-700"
        ></div>
        <div
          class="mb-2.5 h-2 max-w-[490px] rounded-full bg-gray-200 dark:bg-gray-700"
        ></div>
        <div
          class="mb-2.5 h-2 max-w-[440px] rounded-full bg-gray-200 dark:bg-gray-700"
        ></div>
        <div
      ...
      <div>
        <div
          class="mb-4 h-28 w-full rounded-lg bg-gray-200 dark:bg-gray-700"
        ></div>
      </div>
    </div>
  </div>
