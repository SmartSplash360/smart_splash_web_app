<template>
    <form  class="flex min-h-[500px] flex-col gap-5 rounded-md bg-white dark:bg-[#31353F]">
...
const createTechnician = async () => {
  if(validateForm()){
    try {
      ...
      toast.add({ severity: 'success', summary: 'Technician', detail: 'Technician created successfully', life: 5000 });
